...
Live group chat plugin for WordPress. Integrate an online group chat for members only or social open chat on your website or for a live online event
...
== Screenshots ==
1. The most advanced chat platform for WordPress with over than 706,000 installations, upload files, images, and docs.
2. Chat chat skin with advanced design and CSS. You can share any type of file, image, video, link, or emoji to the group chat.
3. Moderated chat where you approve messages before they show up. Let chat admins perform functions such as screening inbound messages before they go live, limiting the users, banning a specific user, changing the chat type, exporting transcripts, filtering profanity, and more.
4. Polls provide streamlined audience feedback in real-time. Let your participants weigh in on the topic by getting their opinions through the polls feature.
...
See the video here https://youtu.be/u3NBNWVy6fk
